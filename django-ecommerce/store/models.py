...
class Category(MPTTModel):
    ...
    name = models.CharField(
        verbose_name=_("Category Name"), help_text="Required and unique", max_length=255, unique=True
    )
...
class ProductType(models.Model):
    """
    The Product Type table will provide a list of the different types of products that are for sale.
    """

    name = models.CharField(verbose_name=_("Product Type"), help_text=_("Required"), max_length=255)
    is_active = models.BooleanField(default=True)
...
class Product(models.Model):
    ...
    slug = models.SlugField(verbose_name=_("Product safe URL"), max_length=255, unique=True)
